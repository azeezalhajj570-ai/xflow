...
class SocialMediaYoutube(models.Model):
    ...
    def _add_youtube_accounts_from_configuration(self, youtube_oauth_client_id, redirect_uri=None):
        ...
        params = {
            ...
            'redirect_uri': redirect_uri or url_join(self.get_base_url(), "social_youtube/callback"),
            'response_type': 'code',
            'scope': ' '.join([
